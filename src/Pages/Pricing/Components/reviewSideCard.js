...
const ReviewSideCard = () => {
  return (
    <>
      <div class="w-88 lg:h-96 md:h-72 h-84 review-card-back rounded-2xl p-6 overflow-hidden">
        ...
        <h1 class="font-inter font-semibold text-base text-white pt-3">
          Demo paragraph just can't get enough want to get a Shirt.
        </h1>
        <p class="font-inter font-normal  md:text-sm	line-clamp-9  lg:text-sm  leading-relaxed text-sm leading-6 font-gray pt-2 overflow-hidden">
